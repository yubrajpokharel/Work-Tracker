    ...
    <table id="table_user" class="display" style="font-size:12px">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo base_url('index.php/viewEmp'.'/'.$user->user_id);?>"><i title="View" class="fa fa-eye text-success"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="<?php echo base_url('index.php/editEmp'.'/'.$user->user_id);?>"><i title="Edit" class="fa fa-edit text-primary"> </i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                    <?php if($user->banned != 1) { ?>
                    <a href="<?php echo base_url('index.php/deleteEmp'.'/'.$user->user_id);?>"><i title="Delete" class="fa fa-times text-danger"></i></a>
                    <?php }?>
                </td>
            </tr>
            <?php
