...
<div class="row">
    <div class="col-md-12">
      <form method="post" class="form-horizontal" action="<?php echo base_url('index.php/manager/update_employee')?>" id="adduser" role="form">
        <br>
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="number" name="salary" id="salary" value="<?php echo $user->salary;?>" placeholder="Salary in $" class="form-control imp" required>
            </div>
