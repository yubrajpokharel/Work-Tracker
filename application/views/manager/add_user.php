      ...
      <form class="form-horizontal" id="adduser" role="form">
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <label class="col-sm-2 control-label" for="join_date">Join Date <span style="color:#f68ca6">*</span></label>
            <div class="col-sm-4">
...
<script type="text/javascript">
  $(document).ready(function(){
    $("#submitbutton").click(function(e){  // passing down the event o form submit
      ...
      if(fname == "" || lname=='' || email=='' || status=='' || pass=='' || salary==''){
        if(pass != repass){
          alert('password not matched');
        }
          $('.add-error').html('<h4>Please provide the mandatory feilds.</h4>');
         $('.imp').addClass('error');
      }
      else{

        $.ajax({
           url:'<?php echo base_url("index.php/manager/save_employee")?>',
           type: 'POST',
